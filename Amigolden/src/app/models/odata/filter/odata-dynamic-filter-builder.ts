...
export type StringNumFunc = (s: StringArg) => NumResult;
export type String2NumFunc = (s: StringArg, s2: StringArg) => NumResult;
export type StringNumStringFunc = (s: StringArg, n: NumArg) => StringResult;
...
export class ODataDynamicFilterBuilder extends BasicDynamicFilterBuilder {
  ...
  ): IDynamicCollectionPropFilterBuilder<ODataDynamicFilterBuilder> => this.collectionProp(prop, varName)
  ...
  // number operators
  lt = (l: BuilderArg, r: BuilderArg) => this.binaryOperator('lt', l, r); // less than
  gt = (l: BuilderArg, r: BuilderArg) => this.binaryOperator('gt', l, r); // greater than
  le = (l: BuilderArg, r: BuilderArg) => this.binaryOperator('le', l, r); // less than or equals
  ge = (l: BuilderArg, r: BuilderArg) => this.binaryOperator('ge', l, r); // greater than or equals
  eq = (l: BuilderArg, r: BuilderArg) => this.binaryOperator('eq', l, r); // equals
  ne = (l: BuilderArg, r: BuilderArg) => this.binaryOperator('ne', l, r); // not equal
  ...
  // TODO: this should really be substring which takes in a string an int and returns a string
  // there is an overload which takes in 2 ints for stard and end index
  // substringof: StringBoolFunc =                     (left, right) => this.function('substringof', left, right);
  contains: StringBoolFunc =                        (l, r) => this.function('contains', l, r);
  length: StringNumFunc =                          (str) => this.function('length', str);
  indexof: String2NumFunc =                         (l, r) => this.function('indexof', l, r);
  replace: StringFunc3 =                            (str, remove, add) => this.function('replace', str, remove, add);
  substring: StringNumStringFunc =                  (str, index) => this.function('substring', str, index);
